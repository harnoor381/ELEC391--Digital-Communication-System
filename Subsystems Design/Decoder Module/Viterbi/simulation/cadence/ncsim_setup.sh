...
mkdir -p ./libraries/viterbi_ii_0/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/src/viterbi_viterbi_ii_0_ini.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/vi_interface.vhd"              -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/vi_functions.vhd"              -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_dspip_avalon_str_ctrl.vhd" -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_add_tre.vhd"           -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_ram.vhd"               -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_sel.vhd"               -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_top.vhd"               -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/src/auk_vit_var_enc.vhd"           -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/viterbi_viterbi_ii_0.v"            -work viterbi_ii_0 -cdslib ./cds_libs/viterbi_ii_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/viterbi.v"                                                                                              
fi
